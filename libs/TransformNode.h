...
public:
	...
	const ofMatrix4x4* getWorldMatrixInverted() const;
	const ofMatrix4x4* getLocalMatrixInverted() const;
...
private:
	...
	const ofMatrix4x4 *world_matrix_inverted_ptr_;
	ofMatrix4x4 world_matrix_inverted_;
	const ofMatrix4x4 *local_matrix_inverted_ptr_;
	ofMatrix4x4 local_matrix_inverted_;
};
